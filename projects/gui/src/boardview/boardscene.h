...
class BoardScene : public QGraphicsScene
{
	...
	public:
        ...
        void moveChess(QPointF src, QPointF dist);
        QPointF transformationSrcCoordinate(QString* src);
        QPointF transformationDistCoordinate(QPointF pos_src, QString* src);
